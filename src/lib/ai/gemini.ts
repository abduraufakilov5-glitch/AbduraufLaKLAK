...
const responseSchema = { type: "object", properties: { seo_title_ru: { type: "string" }, seo_title_tg: { type: "string" }, description_ru: { type: "string" }, description_tg: { type: "string" }, short_description: { type: "string" }, characteristics: { type: "array", items: { type: "object", properties: { name: { type: "string" }, value: { type: "string" } }, required: ["name", "value"] } }, laklak_tags: { type: "array", items: { type: "string" } }, keywords: { type: "array", items: { type: "string" } }, hashtags: { type: "array", items: { type: "string" } } }, required: ["seo_title_ru","seo_title_tg","description_ru","description_tg","short_description","characteristics","laklak_tags","keywords","hashtags"] };
