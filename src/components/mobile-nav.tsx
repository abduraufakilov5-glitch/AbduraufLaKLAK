    ...
    <>
      <header className="sticky top-0 z-30 border-b border-[var(--line)] bg-[color:var(--background)]/92 px-4 py-3 backdrop-blur-xl md:hidden">
        <div className="flex items-center justify-between">
          ...
          {activeSecondary ? <Link href={activeSecondary[1]} className="grid size-9 place-items-center rounded-xl border border-[var(--line)] bg-[var(--card)] text-[var(--muted)]"><activeSecondary.2 size={17} /></Link> : <Link href="/notifications" aria-label="Уведомления" className="grid size-9 place-items-center rounded-xl border border-[var(--line)] bg-[var(--card)] text-[var(--muted)]"><Bell size={17}/></Link>}
        </div>
      </header>
